                ...
                <List.Item>
                  ...
                  <Space direction="vertical">
                    <Row gutter={[16, 16]}>
                      ...
                      <Col span={12} className="left-align">{item.phone}</Col>
                    </Row>
                  </Space>
                </List.Item>
              )}
                ...
                <List.Item key={item.title} style={{ borderBottom: '1px solid #ddd' }}>
                  ...
                  <Space direction="vertical">
                    <Row gutter={[16, 16]}>
                      ...
                      <Col span={12} className="right-align">{selectedOrder.itemsPrice} VND</Col>
                      <Col span={12} className="left-align">Phí vận chuyển:</Col>
                      <Col span={12} className="right-align">{selectedOrder.shippingPrice} VND</Col>
                      <Col span={12} className="left-align">Tổng giá trị đơn hàng:</Col>
                      <Col span={12} className="right-align">{selectedOrder.totalPrice} VND</Col>
